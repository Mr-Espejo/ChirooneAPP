...
import {
  pollMediaTask
} from "../../../../../chunk-OHTQKCV7.mjs";
import {
  require_ms
} from "../../../../../chunk-PS5Y5CMC.mjs";
import "../../../../../chunk-WIW3Q5NZ.mjs";
import {
  prisma,
  schedules_exports
} from "../../../../../chunk-VPKR5UDZ.mjs";
...
// triggers/ideationCron.ts
init_esm();

// modules/ideation/blitzCreativeWeek.usecase.ts
init_esm();
...
async function fileFromPath2(path3, ...args) {
  const { fileFromPath: _fileFromPath } = await import("../../../../../fileFromPath-AUKLN4TS.mjs");
...
var EventStream = class {
  ...
  constructor() {
    ...
    __classPrivateFieldSet4(this, _EventStream_connectedPromise, new Promise((resolve, reject) => {
      __classPrivateFieldSet4(this, _EventStream_resolveConnectedPromise, resolve, "f");
      __classPrivateFieldSet4(this, _EventStream_rejectConnectedPromise, reject, "f");
    }), "f");
    __classPrivateFieldSet4(this, _EventStream_endPromise, new Promise((resolve, reject) => {
      __classPrivateFieldSet4(this, _EventStream_resolveEndPromise, resolve, "f");
...
var __classPrivateFieldGet9 = function(receiver, state, kind2, f) {
  if (kind2 === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
  if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
  return kind2 === "m" ? f : kind2 === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
};
...
var llmService = {
  get client() {
    ...
    fs.appendFileSync("llm_debug.log", `[${(/* @__PURE__ */ new Date()).toISOString()}] Using baseURL: ${baseURL} for model: ${model}
`);
    return new OpenAI({
  ...
  async chat(prompt, model = process.env.KIEAI_LLM_MODEL || "gemini-3.1-pro") {
  ...
  async structured(prompt, schema, model = process.env.KIEAI_LLM_MODEL || "gemini-3.1-pro") {
    try {
      ...
      fs.appendFileSync("llm_debug.log", `[${(/* @__PURE__ */ new Date()).toISOString()}] Response Status: ${response.status}
`);
...
// modules/generation/media.service.ts
init_esm();
var MediaService = class {
  ...
  apiKey = process.env.KIEAI_API_KEY;
  logoUrl = "https://firebasestorage.googleapis.com/v0/b/studio-7377357488-df5a7.firebasestorage.app/o/MotaiCustomers%2FChiroone-Logo-2.png?alt=media&token=142d6e1c-a584-4de7-979b-5401852db595";
  async createMediaTask(prompt, aspectRatio, companyId, postId) {
    if (!this.apiKey) {
...
var BlitzCreativeWeekUseCase = class {
  static {
    __name(this, "BlitzCreativeWeekUseCase");
  }
  async execute(companyId, brandDna, options) {
    const blitzPromptPath = path.join(__dirname, "../../../ai-context/blitzPrompt.md");
    if (!fs2.existsSync(blitzPromptPath)) {
      throw new Error(`Blitz prompt file not found at ${blitzPromptPath}`);
    }
    const basePrompt = fs2.readFileSync(blitzPromptPath, "utf-8");
...
var weeklyIdeationTask = schedules_exports.task({
  id: "weekly-ideation-task",
  cron: "0 9 * * 1",
  // Monday at 9AM
  run: /* @__PURE__ */ __name(async (payload, io, ctx) => {
    console.log("[Trigger] Running Weekly Ideation Task...");
    const brandDnaPath = path2.join(__dirname2, "../../../ai-context/brandDna.json");
    if (!fs3.existsSync(brandDnaPath)) {
      throw new Error("brandDna.json not found");
    }
    const brandDna = JSON.parse(fs3.readFileSync(brandDnaPath, "utf-8"));
...
humanize-ms/index.js:
   ...
   *)
*/
//# sourceMappingURL=ideationCron.mjs.map
