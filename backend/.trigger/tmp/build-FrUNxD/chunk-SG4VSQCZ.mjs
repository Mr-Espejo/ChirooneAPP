...
var require_fetch = __commonJS({
  "node_modules/@microsoft/fetch-event-source/lib/cjs/fetch.js"(exports) {
    ...
    function fetchEventSource2(input2, _a) {
      ...
      return new Promise((resolve, reject) => {
        ...
        async function create2() {
          ...
          try {
            const response = await fetch2(input2, Object.assign(Object.assign({}, rest), { headers, signal: curRequestController.signal }));
...
var DevDisconnectRequestBody = external_exports.object({
  runFriendlyIds: external_exports.string().array()
});
var DevDisconnectResponseBody = external_exports.object({
  cancelled: external_exports.number(),
  bulkActionId: external_exports.string().optional()
});
...
var CreateInputStreamWaitpointRequestBody = external_exports.object({
  streamId: external_exports.string(),
  timeout: external_exports.string().optional(),
  idempotencyKey: external_exports.string().optional(),
  idempotencyKeyTTL: external_exports.string().optional(),
  tags: external_exports.union([external_exports.string(), external_exports.array(external_exports.string())]).optional(),
  /**
   ...
   */
  lastSeqNum: external_exports.number().optional()
});
var CreateInputStreamWaitpointResponseBody = external_exports.object({
  waitpointId: external_exports.string(),
  isCached: external_exports.boolean()
});
...
var SendInputStreamResponseBody = external_exports.object({
  ok: external_exports.boolean()
});
...
var deploymentCommonProperties = {
  ...
  git: external_exports.object({
    branch: external_exports.string(),
    commitSha: external_exports.string(),
    commitMessage: external_exports.string(),
    commitUrl: external_exports.string(),
    branchUrl: external_exports.string(),
    pullRequestNumber: external_exports.number().optional(),
    pullRequestTitle: external_exports.string().optional(),
  ...
  vercel: external_exports.object({
    deploymentUrl: external_exports.string()
  }).optional()
};
...
async function randomUUID() {
  const { randomUUID: randomUUID2 } = await import("./crypto.node-FM7UGXJT.mjs");
  return randomUUID2();
}
__name(randomUUID, "randomUUID");
async function digestSHA256(data) {
  const { subtle: subtle2 } = await import("./crypto.node-FM7UGXJT.mjs");
...
function createFetchWithResponseHeadersCheck(fetchClient) {
  return (...args) => __async(this, null, function* () {
    ...
    if (response.ok) {
      ...
      const input2 = args[0];
      const urlString = input2.toString();
...
var ApiClient = class {
  ...
  get fetchClient() {
    ...
    const fetchClient = /* @__PURE__ */ __name((input2, requestInit) => {
      const $requestInit = {
        ...requestInit,
        headers: {
          ...requestInit?.headers,
      ...
      return fetch(input2, $requestInit);
    }, "fetchClient");
    return fetchClient;
  }
  getHeaders() {
...
// node_modules/@trigger.dev/core/dist/esm/v3/inputStreams/types.js
init_esm();
var InputStreamOncePromise = class extends Promise {
  static {
    __name(this, "InputStreamOncePromise");
  }
...
// node_modules/@trigger.dev/core/dist/esm/v3/input-streams-api.js
init_esm();

// node_modules/@trigger.dev/core/dist/esm/v3/inputStreams/index.js
init_esm();

// node_modules/@trigger.dev/core/dist/esm/v3/inputStreams/noopManager.js
init_esm();
var NoopInputStreamManager = class {
  static {
    __name(this, "NoopInputStreamManager");
  }
  setRunId(_runId, _streamsVersion) {
  }
  on(_streamId, _handler) {
    return { off: /* @__PURE__ */ __name(() => {
    }, "off") };
  }
...
// node_modules/@trigger.dev/core/dist/esm/v3/inputStreams/index.js
var API_NAME16 = "input-streams";
var NOOP_MANAGER5 = new NoopInputStreamManager();
var InputStreamsAPI = class _InputStreamsAPI {
  static {
    __name(this, "InputStreamsAPI");
  }
  static _instance;
  constructor() {
  }
  static getInstance() {
    if (!this._instance) {
      this._instance = new _InputStreamsAPI();
    }
    return this._instance;
  }
  setGlobalManager(manager) {
  ...
  #getManager() {
    return getGlobal(API_NAME16) ?? NOOP_MANAGER5;
  }
...
// node_modules/@trigger.dev/core/dist/esm/v3/input-streams-api.js
var inputStreams = InputStreamsAPI.getInstance();

// node_modules/@trigger.dev/core/dist/esm/v3/waitpoints/index.js
init_esm();
...
// node_modules/@trigger.dev/core/dist/esm/v3/resource-catalog/index.js
var API_NAME17 = "resource-catalog";
...
var ResourceCatalogAPI = class _ResourceCatalogAPI {
  ...
  setGlobalResourceCatalog(resourceCatalog2) {
    return registerGlobal(API_NAME17, resourceCatalog2);
  }
  disable() {
  ...
  #getCatalog() {
    return getGlobal(API_NAME17) ?? NOOP_RESOURCE_CATALOG;
  }
};
...
// node_modules/@trigger.dev/core/dist/esm/v3/idempotency-key-catalog/index.js
var API_NAME18 = "idempotency-key-catalog";
var IdempotencyKeyCatalogAPI = class _IdempotencyKeyCatalogAPI {
  ...
  #getCatalog() {
    let catalog = getGlobal(API_NAME18);
    if (!catalog) {
      catalog = new LRUIdempotencyKeyCatalog();
      registerGlobal(API_NAME18, catalog, true);
    }
    return catalog;
  }
};
...
@google-cloud/precise-date/build/src/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SG4VSQCZ.mjs.map
